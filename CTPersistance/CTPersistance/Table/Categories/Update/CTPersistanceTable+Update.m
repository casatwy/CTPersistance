...
{
    [self updateKeyValueList:[record dictionaryRepresentationWithColumnInfo:[self.child columnInfo] tableName:[self.child tableName]] primaryKeyValue:[record valueForKey:[self.child primaryKeyName]] error:error];
}
